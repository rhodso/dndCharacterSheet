        ...
        */
        ...
        private void bingoButtonActionPerformed(java.awt.event.ActionEvent evt) {
                if (Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
                        String[] buttons = { "Open Website", "Cancel" };

                        int rc = JOptionPane.showOptionDialog(this,
                                        "This action is not performed by a website, do you want to open it?",
                                        "Open website", JOptionPane.INFORMATION_MESSAGE, 0, null, buttons, buttons[0]);

                        if (rc == 0) {
                                try {
                                        Desktop.getDesktop().browse(new URI(
                                                        "https://richard.keithsoft.com/DiscordBingo/index.php?bingo_id=6"));
                                } catch (IOException e) {
                                        JOptionPane.showMessageDialog(this, "IOException opening website",
                                                        "Could not open website", JOptionPane.ERROR_MESSAGE);
                                } catch (URISyntaxException e) {
                                        JOptionPane.showMessageDialog(this, "URI Syntax Incorrect",
                                                        "Could not open website", JOptionPane.ERROR_MESSAGE);
                                }
                        }
                }
